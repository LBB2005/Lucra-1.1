      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white border border-[var(--color-border)] rounded-2xl shadow-sm px-8 py-8">
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl border border-[var(--color-border)] bg-white hover:bg-[var(--color-sidebar)] text-sm font-medium text-[var(--color-text)] transition-colors duration-150 shadow-sm"
            >
              {/* Google icon */}
